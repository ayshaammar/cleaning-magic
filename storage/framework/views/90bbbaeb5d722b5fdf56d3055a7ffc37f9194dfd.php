...
<div class="slider-container">
  <div class="slider" id="slider">
    <div class="slide">
      <img src="<?php echo e(asset('img/IMG-20250522-WA0003.jpg')); ?>" alt="1" />
    ...
    <div class="slide">
      <img src="<?php echo e(asset('img/IMG-20250522-WA0002.jpg')); ?>" alt="Office Cleaning" />
      <div class="slide-text">
    ...
    <div class="slide">
      <img src="<?php echo e(asset('img/IMG-20250522-WA0001.jpg')); ?>" alt="Home Cleaning" />
      <div class="slide-text">
...
<section class="main-wrapper">
  ...
  <div class="pairs-wrapper">
    <div class="pair">
      <div class="card">
        <img src="<?php echo e(asset('img/service1.jpg')); ?>" alt="Home Cleaning" />
        <h3>Home Cleaning</h3>
        <p>Comprehensive home cleaning services using eco-friendly products to keep your home safe and fresh.</p>
      </div>
      <div class="card">
        <img src="<?php echo e(asset('img/service2.jpg')); ?>" alt="Office Cleaning" />
    ...
    <div class="pair">
      <div class="card">
        <img src="<?php echo e(asset('img/service3.jpg')); ?>" alt="Car Cleaning" />
        <h3>Car Cleaning</h3>
        <p>Interior and exterior car cleaning with the latest equipment and cleaning products.</p>
      </div>
      <div class="card">
        <img src="<?php echo e(asset('img/service4.jpg')); ?>" alt="Mosque Cleaning" />
  ...
  <div class="pairs-wrapper" id="products">
    <div class="pair">
      <div class="card">
        <img src="<?php echo e(asset('img/product1.jpg')); ?>" alt="Eco-friendly Cleaner" />
      ...
      <div class="card">
        <img src="<?php echo e(asset('img/product2.jpg')); ?>" alt="Disinfectant" />
        <h3>Disinfectant</h3>
    ...
    <div class="pair">
      <div class="card">
        <img src="<?php echo e(asset('img/product3.jpg')); ?>" alt="Glass Cleaner" />
        <h3>Glass Cleaner</h3>
        <p>Achieve streak-free, sparkling glass surfaces with our specially formulated glass cleaner.</p>
      </div>
      <div class="card">
        <img src="<?php echo e(asset('img/product4.jpg')); ?>" alt="Carpet Cleaner" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Moon A\magic-clean\resources\views/magic/index.blade.php ENDPATH**/ ?>